...
\fixme{Extender la descripcion del grupo con las lineas de investigacion}
...
% \fixme{Eliminar nombres siguiendo el estilo del parrafo anterior sobre
% computational logic}
...
% and Arabic~\cite{rayner-EtAl:2009:GEAF}. Also participated in projects
% involving
...
% annotations~\cite{multieval} also investigating the application of metrics
% from
