\MySubSection{7. Cronograma de trabajo}
...
lenguaje natural (e.g., parser, construcci\'on sem\'antica, etc.).
Gracias a que la interacci\'on con el usuario est\'a liminata por el entorno
virtual, podemos restringir el lenguaje a interpretar y utilizar recursos ya existentes para resolver las tareas no pragm\'aticas.
